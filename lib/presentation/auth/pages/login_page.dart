    ...
    return BlocListener<AuthBloc, AuthState>(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            // 💡 GIẢI PHÁP: Sử dụng CustomScrollView thay cho LayoutBuilder + IntrinsicHeight
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            // Sửa lại cú pháp tương thích để không sập trên các bản Flutter cũ
  ...
  Widget _buildSocialIcon(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Center(
          // Hiển thị SVG nếu có truyền svgPath, ngược lại hiển thị Icon hệ thống
          child: svgPath != null
              ? SvgPicture.asset(
                  svgPath,
                  width: iconSize,
